  ...
  return (
    <section id="about" className="border-b border-border/60 bg-muted/30">
      <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8">
        <Reveal>
          <SectionHeader eyebrow="Tentang" title="Pendidikan & Latar Belakang" />
        </Reveal>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Universitas Muhammadiyah Parepare · 2020 — 2024
                </p>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h3 className="mt-1 text-xl font-semibold text-primary">
                  Aplikasi Absensi Berbasis Lokasi
                </h3>
                <p className="mt-2 text-sm text-muted-foreground">
                  Dibangun untuk SMAN 5 Pinrang — sistem absensi berbasis web dengan HTML, CSS,
                  JavaScript, dan PHP menggunakan Geolocation API browser untuk memverifikasi
                  kehadiran di lokasi dan mengurangi pencatatan manual.
                </p>
